...
<meta charset="UTF-8">
        ...
        <!-- Meta Description -->
        <meta name="description" content="Discover everything you need to know about moving to Georgia, including visa assistance, real estate options, and relocation services.">
        ...
        <!-- Canonical URL -->
        <link rel="canonical" href="https://movetogeorgia.ge">
        ...
        <script type="application/ld+json">
        {
          ...
          "@type": "Organization",
          "name": "Move to Georgia",
          "url": "https://movetogeorgia.ge",
          "logo": "https://example.com/logo.png", <!-- Replace with your logo URL -->
          "sameAs": [
            "https://www.facebook.com/movetogeorgia",
            "https://www.instagram.com/movetogeorgia"
          ]
        }
        </script>